package com.example.tinynews.ui.details;
...
import com.example.tinynews.databinding.FragmentDetailsBinding;
...
public class DetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            Picasso.get().load(TinyNewsApplication.UNIVERSAL_URL).into(binding.detailsImageView);
        }
